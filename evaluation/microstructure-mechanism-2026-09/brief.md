...
- Brief freeze commit SHA: TBD at freeze commit
...
- Required fields per run: mechanism, seed, latency, all five primary metrics, degenerate-run flags, event-stream sha256, record sha256.
...
- Decision rule: mean difference `PRO_RATA − FIFO`, BCa bootstrap 95% CI, 10,000 resamples, bootstrap seed 424242. A CI containing zero is declared **NULL** and is a valid completion.
...
- the decision-metric difference is **UNSTABLE** in sign across the frozen seeds.
