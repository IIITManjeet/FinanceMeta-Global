...
CONTRACT_ID = "FINANCEMETA-MICROSTRUCTURE-MECHANISM-2026-v5"
...
EXPECTED_FREEZE_TAG = "microstructure-freeze-v5"
...
REQUIRED_DEFECT_IDS = {f"D{i}" for i in range(1, 13)}
...
def validate(data: dict[str, object], doc_path: Path = PROTOCOL_DOC) -> None:
    ...
    require({"microstructure-freeze-v2", "microstructure-freeze-v3", "microstructure-freeze-v4"}.issubset(set(authority["superseded_tags"])), "superseded tag dropped")
