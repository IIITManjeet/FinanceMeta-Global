...
class MicrostructureMechanismContractTests(unittest.TestCase):
    ...
    def test_contract_id_cannot_drift(self) -> None:
        self._reject(lambda d: d.__setitem__("contract_id", "FINANCEMETA-MICROSTRUCTURE-MECHANISM-2026-v6"))
    ...
    def test_freeze_tag_must_be_the_current_version(self) -> None:
        self._reject(lambda d: d["authority"].__setitem__("freeze_tag", "microstructure-freeze-v4"))
